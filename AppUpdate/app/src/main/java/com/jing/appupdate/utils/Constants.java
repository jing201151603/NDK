...
public class Constants {
	...
	//linux remote
	public static final String URL_PATCH_DOWNLOAD = "http://download.tl50.com/dxhj/app/android/ndk/"+PATCH_FILE;
	
	public static final String PACKAGE_NAME = "com.jing.appupdate";
